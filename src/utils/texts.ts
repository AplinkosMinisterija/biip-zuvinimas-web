...
export const validationTexts: any = {
  ...
  coordinatesOutsideLithuania: 'Koordinatės turi būti Lietuvos ribose (LKS-94)',
...
export const inputLabels = {
  ...
  coordinateX: 'X (rytų kryptis)',
  coordinateY: 'Y (šiaurės kryptis)',
...
export const descriptions = {
  email: 'Nurodytu el. pašto adresu darbuotojas gaus pakvietimą prisijungti prie įmonės.',
